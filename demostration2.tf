...
variable "user_contacts1" {
  type = object({
    john=map(list(string))
    jane=map(list(string))
})
  default = {
    john = {
...
variable "user_contacts2" {
  type = map(object({
    email=list(tuple([string, string, bool]))
    phone=list(tuple([string, string, bool]))
  }
  ))
  default = {
    "john" = {
      "email" = [
        ["john@example.com",  "2022-01-01",  true],
        ["john@gmail.com",   "2022-02-01",   false]
      ]
      "phone" = [
        [ "555-555-1234", "2022-01-01",  true]
      ]
    }
    "jane" = {
      "email" = [
        [ "jane@example.com",  "2022-02-01",  true],
        [ "jane@gmail.com",   "2022-03-01", false]
      ]
      "phone" = [
        ["555-555-5678", "2022-02-01", true],
        ["555-555-4321",  "2022-03-01",  false]
      ]
    }
  }
}
